...
export default function LegalNoticePage() {
    const legalNoticeSections = [
        {
            title: "Overview",
            icon: <Shield className="w-6 h-6 text-[#1E7A6F]" />,
            content: [
        ...
        },
        {
            ...
            icon: <CheckCircle className="w-6 h-6 text-[#1E7A6F]" />,
            content: [
        ...
        },
        {
            ...
            icon: <Scale className="w-6 h-6 text-[#1E7A6F]" />,
            content: [
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA]">
            ...
            {/* Hero Section */}
            <section className="bg-gradient-to-br from-[#1E7A6F] to-[#2A9D8F] py-16 text-white text-center">
                <div className="container mx-auto px-4">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Legal Notice & Disclaimer</h1>
            ...
            <main className="container mx-auto px-4 py-12">
                <div className="max-w-4xl mx-auto space-y-8">
                    {legalNoticeSections.map((section, idx) => (
                        <div key={idx} className="bg-white rounded-xl p-8 shadow-sm border border-[#E6E8E6]">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="p-3 bg-emerald-50 rounded-lg">
                                    {section.icon}
                                </div>
                                <h2 className="text-2xl font-bold text-[#1E7A6F]">{section.title}</h2>
                            </div>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-sm border border-[#E6E8E6]">
                        <h3 className="text-xl font-bold text-[#1E7A6F] mb-6">Users remain responsible for:</h3>
