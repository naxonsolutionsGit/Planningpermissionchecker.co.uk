    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="search" className="space-y-8 w-full">
            {/* Remove max-w-4xl from the container to allow full width */}
            <div className="w-full space-y-8">
              ...
              {/* AddressSearchForm will now take full width */}
              <AddressSearchForm />

              {/* Keep other sections constrained if needed */}
              <div className="container mx-auto px-4">
                <div className="bg-card rounded-xl p-8 border border-border shadow-sm max-w-4xl mx-auto">
                  <h2 className="text-2xl font-semibold text-card-foreground mb-6 text-center">What We Check For</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                      ["Article 4 Direction", "Conservation Areas", "Listed Buildings"],
