  ...
  if (variant === "compact") {
    return (
      <Alert className="bg-[#F8F7F3] border-[#EEECE6] flex justify-center items-center gap-2 [&>svg]:static [&>svg]:transform-none [&>svg]:left-auto [&>svg]:top-auto [&>svg~*]:pl-0 shadow-none">
        <Shield className="h-4 w-4 text-[#25423D]" />
        <AlertDescription className="text-xs">
          <span className="font-semibold uppercase tracking-widest text-[#9A9488]">
            <Link href="/legal-notice" className="hover:text-[#25423D] transition-colors underline underline-offset-4">
    ...
    <div className="space-y-4">
      ...
      <Card className="bg-[#FAF9F6] border-[#EEECE6] shadow-none">
        ...
        <CardContent className="space-y-4 text-[13px] text-[#4A4A4A] px-6 pb-6">
          ...
          <div className="space-y-1.5">
            <p className="font-bold text-[#25423D] uppercase tracking-wider text-[11px]">Not Professional Advice</p>
            <p className="leading-relaxed">
          ...
          <div className="space-y-1.5">
            <p className="font-bold text-[#25423D] uppercase tracking-wider text-[11px]">Recommendation</p>
